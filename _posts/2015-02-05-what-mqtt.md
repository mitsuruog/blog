...
作ったデモは<https://mitsuruog.github.io/what-mqtt/>で動かすことが出来ます。  
...
- [IoT に最適化された MQTT プロトコルとそれを実現する技術(PDF)](https://ngm2m.jp/m2m/files/symp2014_suzuki_pm.pdf)
- [MQTT についてのまとめ — そこはかとなく書くよん。](https://tdoc.info/blog/2014/01/27/mqtt.html)
- [Mosquitto(MQTT)を動かしてみた - 人と技術のマッシュアップ](https://tomowatanabe.hatenablog.com/entry/2014/04/21/095650)
- [初めての MQTT](https://gist.github.com/voluntas/89000a06a7b79f1230ab)
- [MQTT と JavaScript - @ledsun blog](https://ledsun.hatenablog.com/entry/2014/08/13/141908)
...
- [MQTT over WebSockets](https://test.mosquitto.org/ws.html)
- [MQTT over Websockets with HiveMQ](https://www.hivemq.com/mqtt-over-websockets-with-hivemq/)
...
MQTT クライアントをブラウザ上で動かすには Websocket を使うという話でした。先日行われた[HTML5 Conference 2015](https://events.html5j.org/conference/2015/1/)でも IoT 系のセッションが多く、今年のトレンドは IoT 一色だなと感じています。
...
- [IoT 時代を支えるプロトコル「MQTT」（前編）：CodeZine](https://codezine.jp/article/detail/8000)
- [IoT 時代を支えるプロトコル「MQTT」（中編）：CodeZine](https://codezine.jp/article/detail/8019)
- [IoT 時代を支えるプロトコル「MQTT」（後編）：CodeZine](https://codezine.jp/article/detail/8020)
- [MQTT(本家)](https://mqtt.org/)
