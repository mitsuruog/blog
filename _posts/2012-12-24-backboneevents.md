...
comments: true
tags: [backbone, jasmine]
categories: ["Blog", "フレームワーク"]
---

[Backbone.js Advent Calendar 2012](https:https://www.adventar.org/calendars/15)の 22 日目の記事です。
...
[https:https://github.com/mitsuruog/Learning_JS/tree/master/backbone/functional_test](https://github.com/mitsuruog/Learning_JS/tree/master/backbone/functional_test)
...
で、きっかけは
[@ahomu](https:https://twitter.com/ahomu "https:https://twitter.com/ahomu")さんの「[render と presenter の分離パターン](https:https://havelog.ayumusato.com/develop/javascript/e541-backbone_patterns_tips.html)」を読んで、いいなと思ったのですが、その前に Backbone.Events 自体あまり理解して無いと思ったので、自分の認識が合っているかテストをして確認してみた次第です。
...
https://フラグのようなものを付けた呼び出し
obj.trigger("hello:me");
obj.trigger("hello:you");

https://スペース区切りで複数呼び出し
