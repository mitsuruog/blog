...
categories: ["Blog", "テスト"]
image: https://s3-ap-northeast-1.amazonaws.com/blog-mitsuruog/images/2016/ng-sake.jpg
---

3/31 に酒を飲みながら Angular について話す素敵な催し[ng-sake](https://connpass.com/event/27707/)が開催されたので、Angular2 のユニットテストについて話て来ました。

<!-- more -->

当日のレポートは主催の[らこ](https://twitter.com/laco0416)さんが書いたものを参照ください。

- [ng-sake を開催しました | Angular2 Info](https://ng2-info.github.io/2016/03/31/ng-sake-1-report/)
...
[Angular2 Unit Testing - カバレッジ編 | I am mitsuruog](https://blog.mitsuruog.info/2016/03/how-to-test-angular2-application-coverage.html)で紹介したカバレッジが出る仕組みが入っています。
