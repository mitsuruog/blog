...
comments: true
tags: [fiddler2, openui5, reverseproxy, sapui5]
...
static function OnBeforeRequest(oSession: Session) {
  ...
  https://services.odata.orgへのリバースプロキシ設定
  //
  https://localhostdで/Northwind/というコンテキストがある場合に
  https://services.odata.org:80ドメインへリクエストを投げます。
...
これで、Web アプリケーションから「`http:https://localhost/Northwind/Northwind.svc/Categories`」にリクエストを投げた場合、プロキシサーバにて「`https://services.odata.org/Northwind/Northwind.svc/Categories`」のリソースを取得してくれます。
